...
const VehiclesTable = ({
  ...
  const handleSort = (item_id: any, headerName: any) => {
    const item: any = document.getElementById(item_id);
    if (item) {
      item.classList.toggle("down");

      // if (headerName == "Signup date" && item.classList.contains("down")) {
                  ...
                  {data?.map((data: any) => {
                    return (
                      <Tr>
                        ...
                        <Td>{data?.chasisNumber}</Td>
                        <Td>{data?.plateNumber}</Td>
                        <Td>{data?.owner?.ownerName}</Td>
                        <Td>{data?.manufactureCompany}</Td>
